  ...
  return (
    <div className='flex items-start gap-14'>
        ...
        <div className='w-full flex flex-col items-center gap-5'>
            <Link href='categories/add' className='ml-auto flex items-center gap-2 p-2 rounded-lg bg-blue-400 hover:bg-blue-300 duration-200 text-white mt-2'>
                <p>Add Category</p>
                ...
                <div className='w-full flex flex-wrap justify-center items-center gap-3 mt-10'>
                    {categories?.map((category: CategoryData) => (
                        <span key={category._id} className='flex flex-col justify-center items-center gap-3 border-[1px] border-solid border-green-500 hover:border-green-300 duration-200 p-2 rounded-xl'>
                            ...
                            <span>
                                <Link href={`categories/update/${category._id}`}>
                                    <FontAwesomeIcon icon={faEdit} className='mr-3 duration-200 text-blue-500 hover:text-blue-400 cursor-pointer' />
                                </Link>
